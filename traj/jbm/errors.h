...
static char *errors_bcv[] = { "None.", "Near velocity must be greater than the far velocity.", "BC is higher than 4.0 (please send me that bullet!)" };
...
static char *errors_bct[] = { "None.", "Invalid near velocity.", "Entered time of flight is impossible for entered velocity and time.",
...
static char *errors_drag[] = { "None.", "Base diameter must be less than one caliber.", "Meplat diameter must be less than half the caliber.",
		"Nose length must be longer than one caliber.", "Nose radius must be greater than one caliber.",
		"Total length must be greater than the nose length and boattail length" };

#define  ERROR_NOERROR          0

static char *errors[] = { "None.", };

/* Maximum distance errors */

#define  ERROR_MAXDIST_NOERROR          0

static char *errors_maxdist[] = { "None.", };
...
static char *errors_pbr[] = { "None.", "Sight Height must be inside the vital zone"
...
static char *errors_traj[] = { "None.", "Maximum range must be greater than the zero range and minimum range.",
		"Minimum range must be less than the zero range and maximum range.", "Zero range must be between the minimum and maximum range." };
